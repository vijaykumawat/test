                ...
                <div class="container-fluid">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb align-items-center">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted text-decoration-none" href="<?= base_url('/employee/dashboard') ?>">
                                                <i class="ti ti-home fs-5"></i>
                                            </a>
                                        </li>
                                        <li class="breadcrumb-item">
                                            <a class="text-muted text-decoration-none"
                                                href="<?= base_url('/employee/policies-sold') ?>">
                                                Policy
                                            </a>
                                        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 ">
                            ...
                            <form action="<?= site_url('employee/policy-update') ?>" method="post"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <!-- Download icon -->
                                            <a href="<?= base_url('employee/download-policy/'.$policy['policy_id']) ?>"
                                        ...
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <iframe
                                                        src="<?= base_url('employee/preview-policy/'.$policy['policy_id']) ?>"
