...
<script>
    ...
    function fetchPolicies() {
        ...
        fetch('<?= site_url('admin/search-api') ?>?q=' + encodeURIComponent(search) + '&page=' + currentPage + '&per_page=' + perPage)
            ...
            .then(data => {
                ...
                if (data.data.length === 0) {
                    tbody.innerHTML = '<tr><td colspan="8" class="loading">No policies found.</td></tr>';
                } else {
