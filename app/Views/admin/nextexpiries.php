...
<body>
  ...
  <script>
    ...
    function fetchPolicies() {
        ...
        fetch('<?= site_url('admin/next-expiries-api') ?>?q=' + encodeURIComponent(search) + '&page=' + currentPage + '&per_page=' + perPage)
            ...
            .then(data => {
                ...
                if (data.data.length === 0) {
                    tbody.innerHTML = '<tr><td colspan="8" class="loading">No upcoming expiries found.</td></tr>';
                } else {
