...
<head>
    ...
    <title>Admin Chat | Insurance Portal</title>
...
<body>
    ...
    window.CHAT_CONFIG = {
        baseUrl: "<?= base_url() ?>",
        employeesUrl: "<?= site_url('admin/chat/employees') ?>",
        recentUrl: "<?= site_url('admin/chat/recent') ?>",
        messagesUrl: "<?= site_url('admin/chat/messages') ?>",
        sendUrl: "<?= site_url('admin/chat/send') ?>",
