...
<body>
              ...
              <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-3 align-items-center">
                        <h4 class="card-title mb-0">Current Month Expiries</h4>
                        <div class="ms-auto">
  ...
  <script>
    ...
    function fetchPolicies() {
        ...
        fetch('<?= site_url('admin/current-expiries-api') ?>?q=' + encodeURIComponent(search) + '&page=' + currentPage + '&per_page=' + perPage)
